<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoaiKhac.aspx.cs" Inherits="pizza.LoaiKhac" %>
...
<body>
    ...
    <ul class="products">
        <li>
         ...
         <li>
             <div class="products-item">
                  <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgkhac/khac.jpeg" alt="" />
                        </a>
                      <a href="chuyenhang" class="buy-now">Mua Ngay</a>
             </div>
            <div class="products-info">
                    <a href="" class="products-cat">Bánh</a>
                    <b><a href="" class="products-name">Pizza SALAMI</a></b>
                    <div class="products-price">170.000đ</div>
            </div>
        </div>
         <li>
                <div class="products-item">
                    <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgkhac/khacc.jpg" alt="" />
                        </a>
                        <a href="chuyenhang" class="buy-now">Mua Ngay</a>
              </div>
                <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <b><a href="" class="products-name">Pizza MICHIGAN</a></b>
             <div class="products-price">170.000đ</div>
         </div>
     </div>
              <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="imgkhac/khacss.jpg" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza BACON</a>
             <div class="products-price">150.000đ</div>
         </div>
     </div>
                   <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="imgkhac/loaikhac.jpg" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza MARGHERITA</a>
             <div class="products-price">150.000đ</div>
         </div>
     </div>
