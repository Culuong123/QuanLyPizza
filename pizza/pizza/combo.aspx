<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="combo.aspx.cs" Inherits="pizza.combo" %>
            ...
            <div class="products-item">
                <div class="products-top">
                    <a href="chuyenhang" class="products-thumb">
                        <img src="imgcombo/combo1.png" alt="" />
                    </a>
                    <a href="chuyenhang" class="buy-now">Mua Ngay</a>
                </div>
                <div class="products-info">
                    <a href="" class="products-cat">Combo</a>
                    <a href="" class="products-name">Combo 1</a>
                    <div class="products-price">250.000đ</div>
                </div>
            </div>
         <li>
             <div class="products-item">
                  <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgcombo/Combo-3-.png" alt="" />
                        </a>
                      <a href="chuyenhang" class="buy-now">Mua Ngay</a>
             </div>
            <div class="products-info">
                    <a href="" class="products-cat">Combo</a>
                    <b><a href="" class="products-name">Combo 2</a></b>
                    <div class="products-price">300.000đ</div>
            </div>
        </div>
         <li>
                <div class="products-item">
                    <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgcombo/Combo-.png" alt="" />
                        </a>
                        <a href="chuyenhang" class="buy-now">Mua Ngay</a>
              </div>
                <div class="products-info">
             <a href="" class="products-cat">Combo</a>
             <b><a href="" class="products-name">Combo 3</a></b>
             <div class="products-price">450.000</div>
         </div>
     </div>
