<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="douong.aspx.cs" Inherits="pizza.douong" %>
            ...
            <div class="products-item">
                <div class="products-top">
                    <a href="chuyenhang" class="products-thumb">
                        <img src="imgdouong/coca (1).png" alt="" />
                    </a>
                    <a href="chuyenhang" class="buy-now">Mua Ngay</a>
                </div>
                <div class="products-info">
                    <a href="" class="products-cat">Đồ Uống</a>
                    <a href="" class="products-name">CoCa</a>
                    <div class="products-price">30.000đ</div>
                </div>
            </div>
         <li>
             <div class="products-item">
                  <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgdouong/sprite-.png" alt="" />
                        </a>
                      <a href="chuyenhang" class="buy-now">Mua Ngay</a>
             </div>
            <div class="products-info">
                    <a href="" class="products-cat">Đồ Uống</a>
                    <b><a href="" class="products-name">Sprite</a></b>
                    <div class="products-price">30.000đ</div>
            </div>
        </div>
         <li>
                <div class="products-item">
                    <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="imgdouong/sodaquat.png" alt="" />
                        </a>
                        <a href="chuyenhang" class="buy-now">Mua Ngay</a>
              </div>
                <div class="products-info">
             <a href="" class="products-cat">Đồ Uống</a>
             <b><a href="" class="products-name">SoDa Việt Quất</a></b>
             <div class="products-price">20.000đ</div>
         </div>
     </div>
              <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="imgdouong/nuoclocc.png" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Đồ Uống</a>
             <a href="" class="products-name">Nước Lọc</a>
             <div class="products-price">15k/1chai</div>
         </div>
     </div>
