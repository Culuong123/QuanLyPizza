<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pizzaga.aspx.cs" Inherits="pizza.pizzaga" %>
...
<body>
    ...
    <ul class="products">
            ...
            <div class="products-item">
                <div class="products-top">
                    <a href="chuyenhang" class="products-thumb">
                        <img src="img/pizza_BBQ.png" alt="" />
                    </a>
                    <a href="chuyenhang" class="buy-now">Mua Ngay</a>
                </div>
                <div class="products-info">
                    <a href="" class="products-cat">Bánh</a>
                    <a href="" class="products-name">Pizza Gà BBQ</a>
                    <div class="products-price">99.000đ</div>
                </div>
            </div>
         <li>
     ...
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="img/gá_sốt.png" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza Gà Sốt</a>
             <div class="products-price">99.000đ</div>
         </div>
     </div>
                   <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="img/gà_cay.png" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza Gà Cay</a>
             <div class="products-price">125.000</div>
         </div>
     </div>
                        <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="img/pizza_gà_dứa (1).png" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza Gà Nước Dứa</a>
             <div class="products-price">80.000đ</div>
         </div>
     </div>
                            <li>
                       <div class="products-item">
                   <div class="products-top">
                       <a href="chuyenhang" class="products-thumb">
                           <img src="img/gà_nấm- (1).png" alt="" />
                       </a>
                       <a href="chuyenhang" class="buy-now">Mua Ngay</a>
             </div>
               <div class="products-info">
            <a href="" class="products-cat">Bánh</a>
            <b><a href="" class="products-name">Pizza Gà Nấm</a></b>
            <div class="products-price">60.000đ</div>
        </div>
    </div>
