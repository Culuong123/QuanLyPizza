<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pizzahaisan.aspx.cs" Inherits="pizza.pizzahaisan" %>
            ...
            <div class="products-item">
                <div class="products-top">
                    <a href="chuyenhang" class="products-thumb">
                        <img src="pizzaHS/tôm.png" alt="" />
                    </a>
                    <a href="chuyenhang" class="buy-now">Mua Ngay</a>
                </div>
                <div class="products-info">
                    <a href="" class="products-cat">Bánh</a>
                    <a href="" class="products-name">Pizza Tôm</a>
                    <div class="products-price">100.000đ</div>
                </div>
            </div>
         <li>
             <div class="products-item">
                  <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="pizzaHS/sốt tiêu.png" alt="" />
                        </a>
                      <a href="chuyenhang" class="buy-now">Mua Ngay</a>
             </div>
            <div class="products-info">
                    <a href="" class="products-cat">Bánh</a>
                    <b><a href="" class="products-name">Pizza Sốt Tiêu</a></b>
                    <div class="products-price">125.000đ</div>
            </div>
        </div>
         <li>
                <div class="products-item">
                    <div class="products-top">
                        <a href="chuyenhang" class="products-thumb">
                            <img src="pizzaHS/pesto-.png" alt="" />
                        </a>
                        <a href="chuyenhang" class="buy-now">Mua Ngay</a>
              </div>
                <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <b><a href="" class="products-name">Pizza Pesto Xanh</a></b>
             <div class="products-price">120.000đ</div>
         </div>
     </div>
              <li>
     <div class="products-item">
         <div class="products-top">
             <a href="chuyenhang" class="products-thumb">
                 <img src="pizzaHS/chicago.png" alt="" />
             </a>
             <a href="chuyenhang" class="buy-now">Mua Ngay</a>
         </div>
         <div class="products-info">
             <a href="" class="products-cat">Bánh</a>
             <a href="" class="products-name">Pizza ChiCaGo</a>
             <div class="products-price">150.000đ</div>
         </div>
     </div>
